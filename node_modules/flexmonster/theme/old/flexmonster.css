...
@font-face {
  ...
  src: url("../assets/flexmonster-icons.woff?v2.7.0") format("woff"), url("../assets/flexmonster-icons.ttf?v2.7.0") format("truetype"), url("../assets/flexmonster-icons.svg#flexmonster-icons?v2.7.0") format("svg");
  font-weight: normal;
  font-style: normal;
}
...
#fm-pivot-view .fm-grid-layout a.fm-filter-header:hover {
  background-color: #999;
}
...
/* ===== charts ===== */
/* ===== ui ===== */
#fm-toolbar-wrapper #fm-toolbar li:hover > a {
...
#fm-pivot-view .fm-grid-layout #fm-rows-filter div.fm-header {
  border-right: 1px solid #ccc;
  border-bottom: 1px solid #ccc;
}
#fm-pivot-view .fm-grid-layout div.fm-filter-header:hover {
...
#fm-pivot-view .fm-grid-layout #fm-cols-filter div.fm-filter-header {
  border-bottom: 1px solid #ccc;
}
